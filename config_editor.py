#!/usr/bin/env python3
"""
GMO Coin Bot Configuration Editor
Version: 2.0.0
License: MIT License
Copyright (c) 2024 GMO Coin Bot

GUI configuration editor for GMO Coin Automated Trading Bot.
Provides an easy-to-use interface for managing bot settings.
